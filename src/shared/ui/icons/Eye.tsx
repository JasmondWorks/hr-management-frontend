...
export function Eye({ className, variant = "outline", ...props }: IconProps) {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      <path fill={variant === "filled" ? "currentColor" : "none"}
        ...
        strokeWidth="1.5"
      />
      <circle fill={variant === "filled" ? "currentColor" : "none"} cx="12" cy="12" r="3" stroke="currentColor" strokeWidth="1.5" />
    </svg>
  );
}
